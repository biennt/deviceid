...
## pre-login
  ...
  uri=${uriarray[0]}
  msg="<190>#$epochtime#empty#$virtualname#$clientip#12345#$clientip#192.168.100.10:8083#$fqdn#GET#$uri#200#na#0#$diA#$diB#$ua#0#-#"
  echo $msg
...
# doing smthing else, such as transact or download a protected resource
  epochtime=`date +%s%N | cut -b1-13`
  uri=${uriarray[6]}
  msg="<190>#$epochtime#$RANUSERID#$virtualname#$clientip#12345#$clientip#192.168.100.10:8083#$fqdn#GET#$uri#200#na#0#$diA#$diB#$ua#0#$SESSID#"
  echo $msg
