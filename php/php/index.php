...
function print_newsite_form() {
	...
	echo "Original FQDN: <input type='text' name='originfqdn' value='example.com' size=50><br><br>\n";
	...
	echo "#js_import /etc/nginx/conf.d/js/examplecom.js;\n";
	echo "#js_set \$examplecomuName examplecom.examplecomuName;\n";
	echo "#log_format didformat_examplecom '<190>#\$msec_no_decimal#\$examplecomuName#example.com#\$remote_addr#12345#\$xff_ip#\$upstream_addr#\$host#\$request_method#\$uri#\$status#nocontentype#0#\$deviceA#\$deviceB#\$http_user_agent#0#empty#';\n";
	echo "log_format didformat_examplecom '<190>#\$msec_no_decimal#\$remote_user#example.com#\$remote_addr#12345#\$xff_ip#\$upstream_addr#\$host#\$request_method#\$uri#\$status#nocontentype#0#\$deviceA#\$deviceB#\$http_user_agent#0#empty#';\n";
	echo "</textarea>\n<br><br>\n";
	...
	echo "        examplecomuName = String(decodeURIComponent(tmparr2[1]));\n";
	echo "      }\n";
	echo "    }\n";
	echo "    return examplecomuName;\n";
	echo "}\n";
	echo "export default {examplecomuName};\n";
    echo "</textarea>\n";
	echo "</form>\n";
}
...
function print_header() {
	...
	echo "<script async defer src=\"https://dip.zeronaught.com/__imp_apg__/js/f5cs-a_aabz35oIkM-6b92a1c3.js\" id=\"_imp_apg_dip_\"  ></script>";
	echo "  </head>\n";
	echo "  <body>\n";
	echo "<br>\n";
}
